...
public class PresentSimpleFragment extends Fragment {
    private TheoryViewModel theoryViewModel;
    private FragmentPresentSimpleBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_present_simple, container, false);
        ...
        binding.button.setOnClickListener(v -> {
            playIfNotPlaying(R.raw.present_simple1);
        });
        binding.button2.setOnClickListener(v ->
                playIfNotPlaying(R.raw.present_simple2)
        );
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.back.setOnClickListener(v-> {
            Navigation.findNavController(view).navigate(R.id.action_selectedTheoryFragment_to_theoryFragment);
        });
    }
}
