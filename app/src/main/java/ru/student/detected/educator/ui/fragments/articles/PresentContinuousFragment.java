...
import ru.student.detected.page1.databinding.FragmentPresentContinuousBinding;

public class PresentContinuousFragment extends Fragment {
    private TheoryViewModel theoryViewModel;
    private FragmentPresentContinuousBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_present_continuous, container, false);
        ...
        binding.button.setOnClickListener(v -> {
            playIfNotPlaying(R.raw.present_continuous1);
        });
        binding.button2.setOnClickListener(v -> {
            playIfNotPlaying(R.raw.present_continuous2);
        });
        binding.button3.setOnClickListener(v-> {
            playIfNotPlaying(R.raw.present_continuous3);
        });
